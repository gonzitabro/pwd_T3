...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-05-2026 a las 01:40:39
...
(37, 16, 'apertura', '           El ejercicio de apertura es un conjunto de movimientos suaves y controlados que se realizan antes de entrenar para preparar los músculos y articulaciones, aumentar la temperatura corporal y reducir el riesgo de lesiones durante el ejercicio.\r\n', 'aperturas.jpeg', 'comodin.php', 1, 1, 'aperturas'),
(39, 17, 'cocos', '           El ejercicio de apertura es un conjunto de movimientos suaves y controlados que se realizan antes de entrenar para preparar los músculos y articulaciones, aumentar la temperatura corporal y reducir el riesgo de lesiones durante el ejercicio.\r\n', 'vuelo.webp', 'comodin.php', 1, 1, 'vuelolateral'),
(41, 16, 'pressinclinado', '        El press inclinado es un ejercicio de fuerza donde se empuja una barra o mancuernas en un banco inclinado para trabajar principalmente la parte superior del pecho (pectorales), además de los hombros y tríceps   ', 'pressincli.jpg', 'comodin.php', 1, 1, 'pressinclinado'),
(43, 16, 'pressbanca', '           El press de banca es un ejercicio de fuerza en el que se empuja una barra o mancuernas desde el pecho mientras se está acostado en un banco horizontal, y se utiliza principalmente para desarrollar la fuerza y el tamaño del pecho.', 'pressbanca.jpg', 'comodin.php', 1, 1, 'pressbanca'),
(44, 17, 'pressmilitar', '           El press militar es un ejercicio de fuerza en el que se empuja una barra o mancuernas desde la altura de los hombros hasta arriba de la cabeza, con el objetivo principal de desarrollar los músculos de los hombros y la parte superior del cuerpo', 'militar.jpg', 'comodin.php', 1, 1, 'pressmilitar'),
(45, 17, 'vuelos', '           El vuelo lateral es un ejercicio de aislamiento en el que se levantan mancuernas hacia los lados del cuerpo, con el objetivo principal de trabajar los músculos del hombro, especialmente la parte lateral del deltoides.', '', 'comodin.php', 1, 1, 'vuelolaateral'),
(46, 17, 'vuelos', '           El vuelo lateral es un ejercicio de aislamiento en el que se levantan mancuernas hacia los lados del cuerpo, con el objetivo principal de trabajar los músculos del hombro, especialmente la parte lateral del deltoides.', '', 'comodin.php', 1, 1, 'vuelolaateral'),
(47, 17, 'vuelos', '           El vuelo lateral es un ejercicio de aislamiento en el que se levantan mancuernas hacia los lados del cuerpo, con el objetivo principal de trabajar los músculos del hombro, especialmente la parte lateral del deltoides.', '', 'comodin.php', 1, 1, 'vuelolaateral'),
(48, 17, 'elevaciones', '           La elevación frontal es un ejercicio de aislamiento en el que se levantan mancuernas o una barra hacia el frente del cuerpo, con el objetivo principal de trabajar la parte anterior del hombro (deltoides anterior)', 'frontal.png', 'comodin.php', 1, 1, 'elevacionfrontal'),
(49, 18, 'fondos', '           El tríceps braquial es un músculo ubicado en la parte posterior del brazo cuya función principal es extender el codo (estirar el brazo), y es uno de los principales músculos implicados en los movimientos de empuje.', 'fondoban.jpg', 'comodin.php', 1, 1, 'fondobanco'),
(50, 18, 'frances', '           El press francés es un ejercicio de aislamiento en el que se baja y se sube una barra o mancuernas flexionando y extendiendo los codos, con el objetivo principal de trabajar el músculo tríceps en la parte posterior del brazo', 'frances.webp', 'comodin.php', 1, 1, 'pressfrances'),
(51, 18, 'jalones', '           El jalón en polea es un ejercicio de fuerza en el que se tira de una barra hacia el pecho desde una posición sentada, utilizando una máquina de polea alta, con el objetivo principal de trabajar los músculos de la espalda, especialmente el dorsal ancho', 'jalon.gif', 'comodin.php', 1, 1, 'jalonpolea'),
(52, 19, 'peso muerto paa', '           El peso muerto es un ejercicio de fuerza en el que se levanta una barra desde el suelo hasta la cadera, manteniendo la espalda recta, con el objetivo de trabajar varios grupos musculares del cuerpo, especialmente la espalda, piernas y glúteos', 'pesomu.jpg', 'comodin.php', 1, 1, 'pesomuerto'),
(53, 19, 'remo con barra', '           El remo con barra es un ejercicio de fuerza en el que se tira de una barra hacia el abdomen mientras el torso está inclinado, con el objetivo principal de desarrollar la musculatura de la espalda', 'remoba.jpg', 'comodin.php', 1, 1, 'remobarra'),
(54, 19, 'dominaditas', '           Las dominadas son un ejercicio de fuerza en el que se eleva el cuerpo colgado de una barra, tirando con los brazos hasta que la barbilla supera la barra, con el objetivo principal de desarrollar la espalda y los brazos', 'dominada.jpg', 'comodin.php', 1, 1, 'dominadas'),
(55, 21, 'curl martillo', '           El curl martillo es un ejercicio de fuerza en el que se levantan mancuernas con las palmas enfrentadas, con el objetivo principal de trabajar los músculos del brazo, especialmente el bíceps y el braquial', 'curlmar.jpg', 'comodin.php', 1, 1, 'curlmartillo'),
(56, 21, 'curl con barra', '           El curl con barra es un ejercicio de fuerza en el que se flexionan los codos levantando una barra desde la altura de los muslos hasta los hombros, con el objetivo principal de desarrollar los músculos del bíceps.', 'curlba.jpg', 'comodin.php', 1, 1, 'curlbarra'),
(57, 21, 'baiceps inclinado', '           El curl inclinado es un ejercicio de fuerza en el que se realizan flexiones de codo con mancuernas mientras se está sentado en un banco inclinado, con el objetivo principal de trabajar el bíceps de forma más aislada y con mayor rango de movimiento', 'curlbic.png', 'comodin.php', 1, 1, 'curlinclinado'),
(58, 22, 'peso muerto rumano', '           El peso muerto rumano es un ejercicio de fuerza en el que se baja una barra o mancuernas desde la cadera hacia las piernas con las rodillas ligeramente flexionadas, con el objetivo principal de trabajar los femorales, glúteos y la cadena posterior del cuerpo.', 'rumano.png', 'comodin.php', 1, 1, 'rumano'),
(59, 22, 'curl femorales', '           El curl femoral es un ejercicio de aislamiento en el que se flexionan las rodillas llevando los talones hacia los glúteos, con el objetivo principal de trabajar los músculos femorales (isquiotibiales) en la parte posterior del muslo.', 'curlfemo.jpg', 'comodin.php', 1, 1, 'curlfemoral'),
(60, 22, 'curl nordiquiano', '           El curl nórdico es un ejercicio de fuerza excéntrico en el que se baja el cuerpo desde una posición de rodillas controlando la caída hacia adelante, con el objetivo principal de trabajar los femorales (isquiotibiales) y prevenir lesiones en la parte posterior del muslo.', 'nordico.jpg', 'comodin.php', 1, 1, 'curlnordico'),
(61, 23, 'sentadilliana', '           La sentadilla es un ejercicio básico de fuerza en el que se flexionan las rodillas y caderas bajando el cuerpo como si uno se fuera a sentar, y luego se vuelve a subir, con el objetivo principal de trabajar las piernas y glúteos.', 'sentadilla.webp', 'comodin.php', 1, 1, 'sentadilla'),
(62, 23, 'prensita', '           La prensa de piernas es un ejercicio de fuerza realizado en máquina donde se empuja una plataforma con los pies, con el objetivo principal de trabajar los músculos de las piernas, especialmente cuádriceps, glúteos y femorales.', 'prensa.jpg', 'comodin.php', 1, 1, 'prensa'),
(63, 23, 'extencion de cuadricepss', '           La extensión de cuádriceps es un ejercicio de aislamiento realizado en máquina en el que se extienden las rodillas para levantar un peso con las piernas, con el objetivo principal de trabajar los cuádriceps en la parte frontal del muslo.', 'extension.gif', 'comodin.php', 1, 1, 'extencionescuadriceps');
...
(0, 'Mi Trabajo estudiantil', 'MTE', 'Contenidos de entrenamiento muscular                                                                                                                                                                                                                      ', 'Este sitio fué pensado para concentar toda la variada información referida a mi trabajo estudiantil                                                                                       ', 'logo_pp.png', 1, 1, '#520f0f', '#000000', 'gonza', 'EEST BERAZATEGUI 1-4-6', 'ARIAL', '#f70428', '#dbdbdb');
...
(11, 'Electronica Aplicada', 'EA', '    E.E.T.N°1 - Lunes                                                                     ', '           Materia de 7° año de la tecnicatura en Electronica                                                       ', 'logo_t1.png', 1, 0, '#0d0d0d', '#dbdbdb'),
(12, 'Tecnologia de control', 'TC', '        E.E.T.N°6 - Martes                                                      ', '           Materia de 4° año de la tecnicatura en mueble y madera                                            ', 'logo_t6.png', 2, 0, '#0d0d0d', '#dbdbdb'),
(13, 'Proyecto y diseño de sistemas computacionales', 'PDI', 'E.E.T.N°4 - Miercoles                                                      ', '           Materia de 7° año de la tecnicatura en programacion                                            ', 'logo_t4.png', 3, 0, '#0d0d0d', '#dbdbdb'),
(14, 'Proyecto de sitios web dinamicos', 'PWD', '                           E.E.T.N°4 - JUeves                                       ', '            Materia de 7° año de la tecnicatura en programacion                                                       ', 'logo_t4.png', 4, 0, '#0d0d0d', '#dbdbdb'),
(15, 'Proyecto y diseño Electronico', 'PyDE', '                      E.E.T.N°1 -  Viernes                      ', '         Materia de 7° año de la tecnicatura en electronica                                   ', 'logo_t1.png', 5, 0, '#0d0d0d', '#dbdbdb'),
(16, 'pechito', 'pech', '  Grupo muscular que permite empujar objetos y juntar los brazos al frente.                                                     ', '           El pecho es un grupo de músculos (pectorales) que se encargan de empujar los brazos hacia adelante y hacia el centro del cuerpo. Se trabaja en ejercicios como flexiones, press de banca o aperturas                                            ', 'aperturas.jpg', 1, 1, '#4b0606', '#d91212'),
(17, 'hombro', 'homb', '           Hombro = músculos que sirven para levantar y mover el brazo en varias direcciones                                            ', '           El hombro es un grupo de músculos (deltoides) que permite levantar y mover los brazos en distintas direcciones, como hacia arriba, adelante y hacia los lados. Se trabaja en ejercicios como elevaciones laterales y press militar.                                            ', 'vuelos.png', 1, 1, '#00d600', '#126e12'),
(18, 'traiceps', 'trai', '        Músculo del brazo que sirve para estirar el codo y extender el brazo              ', '           El tríceps es un músculo ubicado en la parte trextensiones de tríceps.           ', 'tricep.png', 1, 1, '#17a617', '#126e12'),
(19, 'espalda', 'espa', '         Músculos del torso que ayudan a mantener la postura y hacer movimientos de tirón.                        ', '           La espalda es un grupo de músculos grandes que permite mantener la postura, tirar objetos hacia el cuerpo y estabilizar el tronco. Se trabaja en ejercicios como dominadas, remo y peso muerto.                      ', 'espalda.jpg', 1, 1, '#177e15', '#1f5b2e'),
(21, 'baiceps', 'bice', '           Músculo del brazo que sirve para doblar el codo y levantar objetos.                                 ', '           El bíceps es un músculo ubicado en la parte frontal del brazo que permite flexionar el codo y acercar la mano al cuerpo. Se trabaja en ejercicios como curls con mancuernas y dominadas.                                 ', 'bicep.webp', 1, 1, '#c17e0b', '#130f06'),
(22, 'femorales', 'femo', 'Músculos de la parte trasera del muslo que ayudan a doblar la rodilla y mover la pierna hacia atrás.                      ', '           Los femorales son un grupo de músculos ubicados en la parte posterior del muslo que permiten flexionar la rodilla y extender la cadera. Se trabajan en ejercicios como peso muerto, curl femoral y sprints                      ', 'femoral.webp', 1, 1, '#7e3e3e', ''),
(23, 'cuádriceps', 'cuád', '        Músculos de la parte delantera del muslo que sirven para estirar la pierna                         ', '           El cuádriceps es un grupo de músculos ubicado en la parte frontal del muslo que permite extender la rodilla y enderezar la pierna. Es fundamental en acciones como caminar, correr, saltar y hacer sentadillas.                      ', 'cuadriceps.jpg', 1, 1, '#153779', '#ff0000');
...
--
ALTER TABLE `comodin`
  MODIFY `ID_comodin` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `tecnologias`
  MODIFY `ID_tecnologia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
